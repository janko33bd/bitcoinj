...
public class MainNetParams extends AbstractBitcoinNetParams {
    ...
    public MainNetParams() {
        ...
        bip32HeaderPub = BlackcoinMagic.bcpb; //The 4 byte header that serializes in base58 to "bcpv".
        bip32HeaderPriv = BlackcoinMagic.bcpv; //The 4 byte header that serializes in base58 to "bcpb"
